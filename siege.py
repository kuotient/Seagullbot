...
def search(id):
    try:
        ...
        # message = ''
        # message += "플레이어 : {}\n\n".format(id)
        # message += "|" + "전체".center(18) + "|" + "캐주얼".center(13) + "|" + "랭크".center(13) + "|" + "\n"
        # message += "|" + "".center(18, '-') + "|" + "".center(13, '-') + "|" + "".center(13, '-') + "|" + "\n"
        # message += "|" + "사살".center(18) + "|" + casual["kills"].center(13) + "|" + ranked["kills"].center(13) + "|\n"
        # message += "|" + "사망".center(18) + "|" + casual["deaths"].center(13) + "|" + ranked["deaths"].center(13) + "|\n"
        # message += "|" + "킬뎃".center(18) + "|" + casual["kd"].center(13) + "|" + ranked["kd"].center(13) + "|\n"
        # message += "|" + "승리".center(18) + "|" + casual["wins"].center(13) + "|" + ranked["wins"].center(13) + "|\n"
        # message += "|" + "패배".center(18) + "|" + casual["losses"].center(13) + "|" + ranked["losses"].center(13) + "|\n"
        # message += "|" + "승/패".center(18) + "|" + casual["wlr"].center(13) + "|" + ranked["wlr"].center(13) + "|\n"
        # message += "|" + "".center(18, '-') + "|" + "".center(13, '-') + "|" + "".center(13, '-') + "|" + "\n"
        # return message


    except:
        return '처리중 오류가 발생하였습니다.'
